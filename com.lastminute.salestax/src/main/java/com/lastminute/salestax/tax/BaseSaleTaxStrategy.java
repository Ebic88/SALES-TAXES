...
public class BaseSaleTaxStrategy implements ISaleTaxStrategy {

	public Money calculateTax( SalesLineItem salesLineItem ) {
		Money tax = salesLineItem.getItem().getUnitPrice().multiply( TaxRate.BASE_TAX.getTaxRate() ).multiply( salesLineItem.getQuantity() );
